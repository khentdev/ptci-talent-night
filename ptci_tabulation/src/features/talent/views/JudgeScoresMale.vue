<template>
  ...
  >
    <div
      ...
      :class="
        judgesTalentScoresMales.isPending
          ? ''
    ...
    >
      <div class="overflow-hidden rounded-2xl">
        <feature-offline-state
          v-if="maleError.offline || offline"
        />

        <data-loading-state
          v-else-if="judgesTalentScoresMales.isPending"
        />
        <template v-else>
          <div class="relative">
            <inline-fetch-indicator v-show="judgesTalentScoresMales.isFetching" />
            <feature-header
            ...
            <judges-scores-data-table
              ...
              :is-fetching="judgesTalentScoresMales.isFetching"
              :is-server-error="maleError.serverError"
...
const { judgesTalentScoresMales, refetchJudgesScoresForMales, enableMale, maleError } =
  useJudgesScores();
